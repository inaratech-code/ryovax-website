...
import { portalRegister, type PortalRegisterState } from "./actions";
...
export default function RegisterForm() {
    ...
    const [state, formAction, pending] = useActionState(portalRegister, null as PortalRegisterState);
            ...
            <div className="hidden lg:flex flex-col items-center justify-center p-12 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-lg text-center">
                    ...
                    <p className="text-slate-400 text-lg leading-relaxed">
                        After you register, an admin must approve your profile before you can sign in to your dashboard.
                    </p>
                </div>
            </div>
            ...
            <div className="flex flex-col justify-center px-4 sm:px-8 md:px-12 lg:px-24 py-8 sm:py-0">
                ...
                <div className="max-w-md w-full mx-auto min-w-0">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-8">
                        ...
                        >
                            <div
                                className={`w-12 h-12 rounded-full flex items-center justify-center mb-4 ${role === "buyer" ? "bg-blue-600 text-white" : "bg-slate-100 text-slate-500"}`}
                            >
                                <Building2 size={24} />
                            </div>
                            <h3 className={`font-bold mb-2 ${role === "buyer" ? "text-blue-900" : "text-slate-700"}`}>
                                I&apos;m a Buyer
                            </h3>
                        ...
                        >
                            <div
                                className={`w-12 h-12 rounded-full flex items-center justify-center mb-4 ${role === "supplier" ? "bg-saffron-500 text-slate-900" : "bg-slate-100 text-slate-500"}`}
                            >
                                <Factory size={24} />
                            </div>
                            <h3 className={`font-bold mb-2 ${role === "supplier" ? "text-saffron-900" : "text-slate-700"}`}>
                                I&apos;m a Supplier
                            </h3>
                    ...
                    {role !== "none" && (
                        ...
                        >
                            ...
                            <button
                                type="submit"
                                disabled={pending}
                                className={`w-full font-semibold py-3 rounded-xl transition-all shadow-md disabled:opacity-60 ${role === "buyer" ? "bg-blue-700 hover:bg-blue-800 text-white" : "bg-saffron-500 hover:bg-saffron-600 text-slate-900"}`}
                            >
                                {pending ? "Submitting…" : `Register as ${role === "buyer" ? "Buyer" : "Supplier"}`}
                            </button>
                        </motion.form>
                    )}
